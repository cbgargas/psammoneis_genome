...
pkgs <- c("report", "skimr", "janitor", "glue", "ggridges", "ggdist", "ggtext", "ggside", "GenomicRanges", "here", "reshape2", "tidyverse", "patchwork", "seqinr", "coRdon", "data.table", "TidyDensity") # Names of packages we want to load
pkgs_tidylog <- c("report", "skimr", "janitor", "glue", "ggridges", "ggdist", "ggtext", "ggside", "GenomicRanges", "here", "reshape2", "tidyverse", "patchwork", "seqinr", "coRdon", "data.table", "TidyDensity", "tidylog") # same as above, but with tidylog if we want more verbose output when using tidy.
...
First, we use the SLURM script 'submit_01_download_ncbi_nr_00_55_pcon06.slurm' to download the most recent NR blast database and taxonomy database. 
...
# One thing we want to do to make things easier is use the prot.accessions2taxid file for assigning sequence origin to our results. Unfortuantely, the full size of this database is >70gb
