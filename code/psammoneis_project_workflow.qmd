...
orthogroups_total <- 
  ...
  # mutate(non_pennate_sum = rowSums(across(c(thalassiosira_pseudonana_total_genes, 
  #                cyclotella_cryptica_total_genes, 
  #                ectocarpus_siliculosus_total_genes, 
  #                nannochloropsis_gaditana_total_genes))))
  mutate(group =
           case_when(
                 rowSums(across(c(thalassiosira_pseudonana_total_genes, 
                 cyclotella_cryptica_total_genes, 
                 ectocarpus_siliculosus_total_genes, 
                 nannochloropsis_gaditana_total_genes,
                 psammoneis_japonica_total_genes,
                 fistulifera_solaris_total_genes,
                 fragilariopsis_cylindrus_total_genes))) == 0 &
                 seminavis_robusta_total_genes >= 1 &
                 pseudonitzschia_multistriata_total_genes >= 1 &
                 pseudonitzschia_multiseries_total_genes >= 1 &
                 phaeodactylum_tricornutum_total_genes >= 1 &
                 nitzschia_nitz4_total_genes >= 1
                   ~ "raphid_pennate",
                 rowSums(across(c(thalassiosira_pseudonana_total_genes, 
                 cyclotella_cryptica_total_genes, 
                 ectocarpus_siliculosus_total_genes, 
                 nannochloropsis_gaditana_total_genes))) == 0 ~ "pennate"
...
orthogroups_cafe <- 
  ...
  mutate(group =
           case_when(
                 rowSums(across(c(thalassiosira_pseudonana, 
                 cyclotella_cryptica, 
                 ectocarpus_siliculosus, 
                 nannochloropsis_gaditana,
                 psammoneis_japonica,
                 fistulifera_solaris,
                 fragilariopsis_cylindrus))) == 0 &
                 seminavis_robusta >= 1 &
                 pseudonitzschia_multistriata >= 1 &
                 pseudonitzschia_multiseries >= 1 &
                 phaeodactylum_tricornutum >= 1 &
                 nitzschia_nitz4 >= 1
                   ~ "raphid_pennate_all",
                 rowSums(across(c(thalassiosira_pseudonana, 
                 cyclotella_cryptica, 
                 ...
                 fistulifera_solaris,
                 fragilariopsis_cylindrus))) == 0 &
                 rowSums(across(c(seminavis_robusta,
                 pseudonitzschia_multistriata,
                 pseudonitzschia_multiseries,
                 phaeodactylum_tricornutum,
                 nitzschia_nitz4))) >= 1
                   ~ "raphid_pennate_any",
                psammoneis_japonica >= 1 &
                 fistulifera_solaris >= 1 &
                 fragilariopsis_cylindrus >= 1 &
                 seminavis_robusta >= 1 &
                 pseudonitzschia_multistriata >= 1 &
                 pseudonitzschia_multiseries >= 1 &
                 phaeodactylum_tricornutum >= 1 &
                 nitzschia_nitz4 >= 1~ "pennate_all",
                 rowSums(across(c(thalassiosira_pseudonana, 
                 cyclotella_cryptica, 
                 ectocarpus_siliculosus, 
                 nannochloropsis_gaditana))) == 0 ~ "pennate_any"
